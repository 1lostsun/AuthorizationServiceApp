...
public class AuthController {
	...
	public ResponseEntity<AuthResponseDto> refreshToken(@RequestBody UserRequestDto userRequestDto) throws JsonProcessingException {
		...
		kafkaProducer.sendMessage("auth-topic", null, new MessageDto(userRequestDto.getEmail(), userRequestDto.getUsername(),"refresh", "User refreshed token", "Thanks for staying with us"));
